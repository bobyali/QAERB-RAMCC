...
public class DatacenterAbstractVm extends Vm {
	...
	public DatacenterAbstractVm(int serialNum,double q1, double q2 , double q3, double q4, double mips, int pesNumber, int ram, long bw,
			long size, VmCharacteristics vmCharacteristics) {
		super( serialNum,true,q1,q2,q3,q4,-1, -1, mips, pesNumber, ram, bw, size, vmCharacteristics.getVmm(), null);
